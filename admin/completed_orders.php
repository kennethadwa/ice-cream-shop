...
// Fetch all completed transactions including order type, ordered by the transaction ID in descending order
$query = "
    SELECT 
        t.transaction_id,
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='print_completed_order.php?transaction_id={$row['transaction_id']}' class='btn btn-info btn-sm'><i class='bi bi-printer'></i> Print</a></td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='8' class='text-center'>No completed orders found.</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
